...
**Organisation GitHub — développement de produits web**
...
Ces repositories sont partagés entre les projets de l'organisation.
...
| URL | Service |
|-----|---------|
| `navimo.fr` | Site public, landing page |
| `navimo.fr/blog` | Blog SEO |
| `dashboard.navimo.fr` | Dashboard (zone authentifiée) |
| `api.navimo.fr` | API REST Laravel |
